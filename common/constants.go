...
const (
	...
	ETH_STORAGE_NATIVE_PREFIX_LENGTH = ETH_STORAGE_PREFIX_LENGTH + len("/native/")
	...
	PARALLELISM_DEGREE = "paraDegree" // The execution parallelism of the function, either parallel or sequential
