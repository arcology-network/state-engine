...
// 	localStore *datastore.LiveStorage[crdtcommon.CRDT, []byte]
// }
...
// 		readonlyClient.localStore = args[0].(*datastore.LiveStorage[crdtcommon.CRDT, []byte])
// 	}
...
// 			return []byte{}, nil
// 		}
// 		return this.localStore.Encoder(nil)(key, v.(crdtcommon.CRDT))
// 	} else {
