...
func NewExecutionCacheIndexer(store storageintf.ReadOnlyStore[string, crdtcommon.CRDT], version int64, filter func(tran *statecell.StateCell) bool) *ExecutionCacheIndexer {
