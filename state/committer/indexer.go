...
func PathIndexer(store storageintf.ReadOnlyStore[string, crdtcommon.CRDT]) *indexer.UnorderedIndexer[string, *statecell.StateCell, []*statecell.StateCell] {
...
func TxIndexer(_ storageintf.ReadOnlyStore[string, crdtcommon.CRDT]) *indexer.UnorderedIndexer[uint64, *statecell.StateCell, []*statecell.StateCell] {
	return indexer.NewUnorderedIndexer(
		nil,
