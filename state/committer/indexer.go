...
func PathIndexer(store interfaces.ReadOnlyStore) *indexer.UnorderedIndexer[string, *statecell.StateCell, []*statecell.StateCell] {
...
func TxIndexer(_ interfaces.ReadOnlyStore) *indexer.UnorderedIndexer[uint64, *statecell.StateCell, []*statecell.StateCell] {
	return indexer.NewUnorderedIndexer(
		nil,
